...
{cases}</testsuite>'''
    ...
    def test_validate_history_path_rejects_non_tmp(self):
    ...
    def test_validate_history_path_accepts_tmp(self, tmp_path):
        """tmp 目录路径被接受。"""
        import tempfile

        tmp_root = os.path.realpath(tempfile.gettempdir())
        validated = _validate_history_path(
            os.path.join(tempfile.gettempdir(), "test_history.json")
        )
